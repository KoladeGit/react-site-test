...
import sty from "./PlasmicFaq.module.css"; // plasmic-import: o-5CrmorLrDo/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__gspE4)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__goH6T)}>
          <div className={classNames(projectcss.all, sty.freeBox__drK8)}>
            {p.renderPlasmicSlot({
