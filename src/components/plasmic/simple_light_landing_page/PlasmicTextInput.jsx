...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: SwBTk4bUPNYv/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: RAyjftQ6reZd/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: Ubz6yvSpO_rh/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg___2Ghd)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__uFvH1)}
                role={"img"}
              />
            ),
